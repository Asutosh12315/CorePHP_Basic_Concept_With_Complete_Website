...
if (isset($_POST["submit"])) {
        ...
        $sql="UPDATE users SET name='$name' , email='$email' , password='$password' , dob='$dob' ,
        gender='$gender' , country='$country' , department='$department' , comments='$comments' ,
        photo='$photo' WHERE id='$searchQueryParameter;'";
        ...
        if ($result) {
            ...
            echo'<script> alert("Hey , your record has been updated successfully !")</script>';
